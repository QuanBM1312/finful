...
import 'load_sliver_grid_view.dart';

class LoadSliverGrid<T extends BaseEntity> extends StatefulWidget {
  LoadSliverGrid({
    Key? key,
  ...
  final SliverGridRender<T>? gridRender;
  ...
  final OnSliverGridItemRemoved<T>? onItemRemoved;
  final OnSliverGridDataIsReady<T>? onDataIsReady;
  final Widget? emptyWidget;
  final Widget? loadingWidget;
  final SliverGridErrorBuilder errorWidget;
  ...
  @override
  State<LoadSliverGrid> createState() => _LoadSliverGridState<T>();
}

class _LoadSliverGridState<T extends BaseEntity>
    extends State<LoadSliverGrid<T>> with WidgetDidMount<LoadSliverGrid<T>> {
        ...
        ? BlocConsumer<LoadListBloc<T>, LoadListState>(
            ...
            builder: (context, state) {
              ...
              return items.isEmpty
                  ...
                  : widget.gridRender != null
                      ? SliverPadding(
                          padding: widget.padding,
                          sliver: widget.gridRender!(asT<List<T>>(items)!),
                        )
                      : LoadSliverGridView<T>(
                          items: items,
                          padding: widget.padding,
                          supportFlatGroup: widget.supportFlatGroup,
                          isCustomGridDelegate: widget.isCustomGridDelegate,
