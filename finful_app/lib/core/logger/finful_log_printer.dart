...
/// ```
///
class FinFulLogPrinter extends LogPrinter {
  ...
  static final levelColors = {
    ...
    Level.warning: AnsiColor.fg(43),
    Level.error: AnsiColor.fg(196),
    Level.fatal: AnsiColor.fg(190),
  };
  ...
  /// for example to prevent boxing of [Level.trace] and [Level.info] use excludeBox:{Level.verbose:true, Level.info:true}
  ...
  FinFulLogPrinter({
    ...
    _middleBorder = '$middleCorner$singleDivider';
    _bottomBorder = '$bottomLeftCorner';
  ...
  List<String> _formatAndPrint(
    ...
    final verticalLineAtLevel =
        (includeBox[level]!) ? (verticalLine + ' ') : '';
    final color = _getLevelColor(level);
    if (includeBox[level]!) {
      final _topTitle = ' [${level.name.toUpperCase()}] | ${time ?? ''} ';
      final _topFormattedBorder =
          _topBorder.replaceRange(2, 2 + _topTitle.length, _topTitle);
      buffer.add(color(_topFormattedBorder));
    }
